 ...
 */
public abstract class SystemInterfacePOA extends org.omg.PortableServer.Servant
        implements SystemInterfaceOperations, org.omg.CORBA.portable.InvokeHandler
{
    public SystemInterface _this()
    {
        return SystemInterfaceHelper.narrow(_this_object());
    }

    public SystemInterface _this(org.omg.CORBA.ORB orb)
    {
        return SystemInterfaceHelper.narrow(_this_object(orb));
    }

    private static String [] _ids_list =
    {
        "IDL:system/SystemInterface:1.0"
    };
